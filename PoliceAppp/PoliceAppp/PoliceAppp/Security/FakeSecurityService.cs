...
using PoliceAppp.Messages.Security;
using PoliceAppp.Models;
using Prism.Events;
...
namespace PoliceAppp.Security
{
    public class FakeSecurityService : ISecurityService
    {
        ...
        public IList<Models.MenuItem> _allMenuItems;
        ...
        public IList<Models.MenuItem> GetAllowedAccessItems()
        {
            if (LoggedIn)
            {
                var accessItems = new List<Models.MenuItem>();
        ...
        IList<Xamarin.Forms.MenuItem> ISecurityService.GetAllowedAccessItems()
        {
